...
class TestSnapSegments:
    def test_no_mesh_segments_all_connected(self):
        ...
        np.testing.assert_array_almost_equal(
            non_mesh_segs.lon1.values, [10.0, 11.0, 10.5]
        )
        np.testing.assert_array_almost_equal(
            non_mesh_segs.lat1.values, [10.0, 10.0, 11.0]
        )

    def test_replaces_mesh_segments(self):
    ...
    def test_hanging_endpoint_snapping(self):
